    ...
    <div class="job-details-card">
      ...
      <div class="card-header">
        ...
        <div class="header-actions">
          ...
          <button class="btn btn-danger" @click="confirmDeleteJob(job)">
            Delete
          </button>
        </div>
      </div>
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <select
                  v-model="editedJob.mode_of_work"
                  class="form-select"
                  :disabled="!isEditing"
                >
    ...
    >
      <div class="dialog" @click.stop>
        ...
        <div class="dialog-actions">
          <button class="btn btn-secondary" @click="deleteDialog = false">
            Cancel
          </button>
